<header class="app-header">
    <a class="app-header__logo" href="index-2.html"><img src="{{asset('images/logo.jpg')}}" style="width: 80px;"></a>
    <!-- Sidebar toggle button-->
    <a class="app-sidebar__toggle" href="#" data-toggle="sidebar" aria-label="Hide Sidebar"><i class="fa fa-bars"></i></a>
    <!-- Navbar Right Menu-->
    <ul class="app-nav">
        <li class="app-search">
